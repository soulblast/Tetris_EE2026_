...
HD_PWD='C:/EE2026 lab/Project/Tetris_EE2026_/tetris.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_keyboard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_keyboard.tcl -notrace
